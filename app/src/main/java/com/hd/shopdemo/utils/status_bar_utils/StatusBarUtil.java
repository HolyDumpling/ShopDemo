package com.hd.shopdemo.utils.status_bar_utils;
...
public class StatusBarUtil {
    ...
    public static void immersive(Window window, int color, @FloatRange(from = 0.0, to = 1.0) double alpha) {
...
//        window.setStatusBarColor(Color.TRANSPARENT);
     ...
     * 创建假的透明栏
     */
    public static void setTranslucentView(ViewGroup container, int color, @FloatRange(from = 0.0, to = 1.0) double alpha) {
    ...
    public static int mixtureColor(int color, @FloatRange(from = 0.0, to = 1.0) double alpha) {
